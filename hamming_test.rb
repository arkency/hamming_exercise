...
class HammingTest < Minitest::Test
  ...
  def test_disallow_incorrect_DNA_code_1
    assert_raises(ArgumentError) { Hamming.compute('XYZ', 'AAA')}
  end

  def test_disallow_incorrect_DNA_code_2
    assert_raises(ArgumentError) { Hamming.compute('AAA', 'XYZ')}
  end
